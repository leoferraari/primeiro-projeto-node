...
class ProviderAppointmentsController {
  async index(request, response) {
    ...
    const istProviderAppointments = _tsyringe.container.resolve(_ListProviderAppointmentsService.default);
    const appointments = await istProviderAppointments.execute({
      provider_id,
      day,
      month,
      year
